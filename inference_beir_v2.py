...
if os.path.exists(args.test_topk_score_path):
    with open(args.test_topk_score_path,'w'):
        pass
if os.path.exists(args.train_topk_score_path):
    with open(args.train_topk_score_path,'w'):
        pass
...
ir_evaluator = evaluation.InformationRetrievalEvaluator(corpus=corpus,
                                                        test_queries=test_queries, test_relevant_docs=test_rel_docs,
                                                        train_queries=train_queries, train_relevant_docs=train_rel_docs,
